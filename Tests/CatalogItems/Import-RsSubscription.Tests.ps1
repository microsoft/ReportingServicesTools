...
Describe 'Import-RsSubscription' {
    
    $TestPath = 'TestDrive:\Subscription.xml'
    Get-NewFileShareSubscription | Export-RsSubscription $TestPath

    
    Context 'Import-RsSubscription' {
        
        Get-NewFileShareSubscription | Export-RsSubscription $TestPath
        $Result = Import-RsSubscription $TestPath
