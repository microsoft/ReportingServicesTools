...
function Set-RSEmailSettingsAsNoAuth
{
    ...
    .EXAMPLE
        Set-RSEmailSettingsAsNoAuth -SmtpServer doe.com -SenderAddress john@doe.com 
        Description
        -----------
        This command will configure the default instance from SQL Server 2016 Reporting Services to use No Authentication with the specified SMTP Server and Sender Address when sending emails.

    .EXAMPLE
        Set-RSEmailSettingsAsNoAuth -SqlServerInstance 'SQL2012' -SqlServerVersion '11' -SmtpServer doe.com -SenderAddress john@doe.com 
        Description
        -----------
        This command will configure the named instance (SQL2012) from SQL Server 2012 Reporting Services to use No Authentication with the specified SMTP Server and Sender Address when sending emails.
    #>
